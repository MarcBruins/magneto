...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/volume1/web/htc/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('config' => new \Symfony\Bundle\AsseticBundle\Factory\Loader\ConfigurationLoader(), 'twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/volume1/web/htc/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('bootstrap_css' => array(0 => array(0 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/less/bootstrap.less', 1 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/less/responsive.less'), 1 => array(0 => 'less', 1 => 'cssrewrite'), 2 => array('output' => '/css/bootstrap.css')), 'bootstrap_js' => array(0 => array(0 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-transition.js', 1 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-alert.js', 2 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-button.js', 3 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-carousel.js', 4 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-collapse.js', 5 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-dropdown.js', 6 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-modal.js', 7 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-tooltip.js', 8 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-popover.js', 9 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-scrollspy.js', 10 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-tab.js', 11 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-typeahead.js', 12 => '/volume1/web/htc/app/../vendor/twitter/bootstrap/js/bootstrap-affix.js'), 1 => array(), 2 => array('output' => '/js/bootstrap.js')), 'jquery' => array(0 => array(0 => '/volume1/web/htc/app/../vendor/jquery/jquery/jquery-1.9.1.js'), 1 => array(), 2 => array('output' => '/js/jquery.js')))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/volume1/web/htc/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/volume1/web/htc/app/Resources');
     ...
     * This method always returns the same instance of the service.
     *
     * @return EntityManager516ffa402e650_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager A EntityManager516ffa402e650_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager instance.
     */
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/volume1/web/htc/app/cache/dev/jms_diextra/doctrine/EntityManager_516ffa402e650.php';

        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_b8e8052b582ed5bc8bbdfd2025ab9b55');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b8e8052b582ed5bc8bbdfd2025ab9b55');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b8e8052b582ed5bc8bbdfd2025ab9b55');
        ...
        $d->setProxyDir('/volume1/web/htc/app/cache/dev/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager516ffa402e650_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/volume1/web/htc/app/Resources');
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/volume1/web/htc/app/cache/dev/jms_diextra/metadata'));
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/volume1/web/htc/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/volume1/web/htc/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/volume1/web/htc/app/cache/dev/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/volume1/web/htc/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['sensio.distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/volume1/web/htc/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/volume1/web/htc/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/volume1/web/htc/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/volume1/web/htc/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/volume1/web/htc/app/cache/dev/translations', 'debug' => true));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/volume1/web/htc/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/volume1/web/htc/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/volume1/web/htc/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        $instance->addPath('/volume1/web/htc/vendor/braincrafted/bootstrap-bundle/Bc/Bundle/BootstrapBundle/Resources/views', 'BcBootstrap');
        $instance->addPath('/volume1/web/htc/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/volume1/web/htc/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/volume1/web/htc/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/volume1/web/htc/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/volume1/web/htc/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/volume1/web/htc/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/volume1/web/htc/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/volume1/web/htc/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/volume1/web/htc/app/Resources/views');
     ...
     *
     * @return EntityManager516ffa402e650_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager An instance of the doctrine.orm.default_entity_manager service
     */
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/volume1/web/htc/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/volume1/web/htc/app/cache/dev/assetic/assets');
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/volume1/web/htc/app/cache/dev/jms_security', true));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/volume1/web/htc/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/volume1/web/htc/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/volume1/web/htc/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/volume1/web/htc/app/cache/dev',
            'kernel.logs_dir' => '/volume1/web/htc/app/logs',
            ...
            'debug.container.dump' => '/volume1/web/htc/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/volume1/web/htc/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/volume1/web/htc/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/volume1/web/htc/app/cache/dev/profiler',
            ...
            'router.resource' => '/volume1/web/htc/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/volume1/web/htc/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => '/volume1/web/htc/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/volume1/web/htc/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/volume1/web/htc/app/../web',
            'assetic.write_to' => '/volume1/web/htc/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/volume1/web/htc/app/cache/dev/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/volume1/web/htc/app/cache/dev/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/volume1/web/htc/app/cache/dev/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(

            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/volume1/web/htc/app/cache/dev/jms_diextra/doctrine/EntityManager_516ffa402e650.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager516ffa402e650_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/volume1/web/htc/app/cache/dev/jms_security',
